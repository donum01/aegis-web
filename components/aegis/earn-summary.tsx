...
export function EarnSummary({ summary }: { summary: EarnSummaryData }) {
  ...
  return (
    <section className="aegis-card overflow-hidden" aria-labelledby="earn-overview-heading">
      <div className="aegis-panel-header">
        <div>
          <h2 id="earn-overview-heading" className="text-lg font-semibold">Earn overview</h2>
          <p className="mt-1 text-xs" style={{ color: "var(--aegis-muted)" }}>Current positions and estimated yield</p>
        </div>
      </div>
